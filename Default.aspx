<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MuzicCourse.Default" %>
...
<head>
	<title>Müzik Okulu Kayıt Paneli</title>
...
<body>
	<h1 class="w3layouts">Müzik Kursu Kayıt Paneli</h1>
	<div class="clear"></div>
	<div class="content-w3ls">
		<div class="form_w3layouts">
			<form action="#" method="post" class="agile_form" runat="server">
				...
				<div class="agileits-left">
					<asp:TextBox ID="TxtMail" runat="server" placeholder="e-Posta Adresiniz"></asp:TextBox>
				</div>
